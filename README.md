...
Fetches an array of popular memes and displays a random meme. Also allows the user to insert captions to the meme image or to change the currenty displayed meme.
